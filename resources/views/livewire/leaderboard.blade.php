<div class="game-area flex h-full w-full items-center justify-center bg-amber-50 p-6" wire:poll.2s.visible>
        ...
        <div class="space-y-3">
            @foreach ($players as $index => $row)
                <div
                    ...
                    class="flex items-center justify-between rounded-2xl px-4 py-3 transition {{ $row->id === $currentPlayerId ? 'bg-amber-200 ring-2 ring-amber-400' : 'bg-white' }}"
                >
